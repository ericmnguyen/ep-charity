         ...
         <div class="row justify-content-center ">
             ...
             <div class="col-3">
                 <div class="f-box">
                     ...
                     <span>Match your Interest </span>
                 </div>
             </div>
             <div class="col-3">
                 <div class="f-box">
                     <i class="fa fa-hand-holding-heart"></i>
                     <span>Give and Take</span>
                 </div>
             </div>
         </div>
     </div>
 ...
 <div class="footer-newsletter">
     <div class="container">
         ...
         <p>Receive our latest updates about new events and opportiunities</p>
     ...
     <div class="container">
         <div class="row g-4 row-cols-2 row-cols-md-3 row-cols-lg-5 m-0 justify-content-center">
             ...
             <div class="col">
                 ...
                 <ul>
                     <li>
                         <a href="<?php echo $root_directory; ?>/signin.php" title="Log In / Register">
                             <span>
                                 Log In / Register
                             </span>
                         </a>
 ...
 <div class="footer-end">
     <div class="container">
         <div class="row align-items-center">
             <div class="col-md-8">
                 <h4>@2024 <span>Social Voulunteer</span>. All Right Reserved</h4>
                 <p>See what makes out online headshop private, secure, and encrypted. | <a href="">Privacy Policy</a> | <a href="">sitemap</a> |</p>
             </div>
         </div>
     </div>
 </div>
